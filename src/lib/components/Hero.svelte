...
<section id="hero" class="hero" bind:this={heroEl}>
  <div class="hero-shell">
    <h1 class="hero-masthead" aria-label="Harpreet Singh">HARPREET SINGH</h1>
...
<style>
  .hero {
    ...
    text-align: center;
    padding: clamp(1rem, 2vw, 1.5rem) 0 var(--space-xl);
  ...
  .hero-masthead {
    ...
    font-size: clamp(5.2rem, 21vw, 21rem);
    font-weight: 900;
    line-height: 0.78;
    ...
    white-space: nowrap;
    transform: scaleX(0.55) scaleY(1.28);
  ...
  @media (max-width: 900px) {
    .hero-masthead {
      font-size: clamp(4rem, 21vw, 12rem);
      line-height: 0.78;
