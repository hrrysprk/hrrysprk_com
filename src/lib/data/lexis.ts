...
export const lexisEntries: LexisEntry[] = [
  ...
  { label: 'Disordered Proteins Project', startDate: '2015-05-01', endDate: '2015-09-01', startAge: 21, endAge: 21.3, type: 'research' },
  ...
  { label: 'Self-directed ML & Bioinformatics', startDate: '2020-10-01', endDate: '2022-02-01', startAge: 26, endAge: 28, type: 'education' },
  ...
  { label: 'Research Projects, UBC', startDate: '2025-08-01', endDate: '2026-06-01', startAge: 31, endAge: 31.8, type: 'research' },
  { label: 'Graduate Teaching Assistant', startDate: '2025-12-01', endDate: '2026-05-01', startAge: 31.3, endAge: 31.7, type: 'work' }
];

export const lexisMarkers: LexisMarker[] = [
  { label: 'relocated to CANADA', date: '2020-08-01', age: 26 },
  { label: 'COVID-19', date: '2020-02-01', age: 26 }
];
